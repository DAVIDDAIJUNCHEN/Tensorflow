...
#------------------------ get rid of the signs, like comma -------------------#
...
#    return _vocabulary, _rev_vocabulary


#def text_dir2id_dir(raw_data_dir, id_dir, _vocabulary, normalize_digits=True, Isch=False):
